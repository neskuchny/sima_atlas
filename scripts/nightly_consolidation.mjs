...
const checks = [
  ...
  ['playwright_canvas', 'node scripts/run_playwright_guarded.mjs tests/playwright/canvas_screenshots.spec.ts'],
  ...
  ['playwright_sima_design', 'node scripts/run_playwright_guarded.mjs tests/playwright/sima_design.spec.ts'],
