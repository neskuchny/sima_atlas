...
const payload = [
  ...
  { jsonrpc:'2.0', id:3, method:'tools/call', params:{ name:'generate_validated_bundle', arguments:{} } },
  { jsonrpc:'2.0', id:4, method:'tools/call', params:{ name:'render_wiki_html', arguments:{} } },
];
