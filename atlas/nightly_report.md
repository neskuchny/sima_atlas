...
_Generated: 2026-05-01T11:15:30.289Z_
...
- ✅ sync_context_packs: ok
  - output: Context packs synced: 9
- ✅ agent_parity: ok
  - output: Agent parity validation: OK
- ✅ parity_matrix: ok
  - output: Parity matrix validation: OK
- ✅ bootstrap_projection: ok
  - output: Bootstrap projection validation: OK
- ✅ bootstrap_regeneration: ok
  - output: Bootstrap regeneration validation: OK
- ✅ generate_wiki: ok
...
- ✅ intelligence_health: ok
  - output: Intelligence health: 1 (9/9)
