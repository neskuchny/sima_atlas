...
_Generated: 2026-05-01T10:00:56.070Z_
...
5. **b.payments** (wip) — Auto: b.payments
6. **b.crm** (wip) — Auto: b.crm
7. **b.ui-control** (done) — UI Control Plane
8. **b.core-sync** (done) — Sync Engine
9. **b.agent-orchestrator** (done) — Agent Orchestrator
