# AUTO ТЗ (auto-generated from atlas)

_Each section is built from `atlas/blocks/<id>/mission.md` + `tasks.md`. Regenerate via `node scripts/generate_tz_from_atlas.mjs`._
...
- [x] T17. R-8.12: разница контракта с момента подтверждения на «Обзоре» (добавлено / изменено / удалено, было / стало) и секция «Формулировка контракта» + строка в Implementation Status.
...
- [x] R-8.12: журнал недоделок судьи — дописыванием в `tasks.md` (из Spec Kit converge), `scripts/convergence_log.mjs`.
...
## PR2.7 — из OpenSpec и Spec Kit (R-8.12, сделано)
- [x] T34. Снимки контракта при объявлении и ответе оператора (по хэшу содержимого) и разница по единицам смысла: A1…, KPI-1…, разделы миссии.
- [x] T35. Разница на «Обзоре», когда рамка устарела, и в промпте переобъявления.
- [x] T36. `contract_lint.mjs`: проверка формулировок без LLM; отчёт в nightly; секция «Формулировка контракта» и строка в Implementation Status.
...
- [x] T14. Вторая полоса здоровья блока — «качество формулировки» отдельно от «состояния приёмки» (R-8.12: строка «Формулировка контракта» + секция на «Обзоре»).
...
_Sources: [mission](blocks/b.clarify/mission.md) · [kpi](blocks/b.clarify/kpi.md) · [acceptance](blocks/b.clarify/acceptance.md) · [tasks](blocks/b.clarify/tasks.md)_
