...
try {
  ...
  // [alive] entries cleaned from b.ui-control/files.md in PR #43. R-8.10 —
  // frontend/atlas_sync.js was listed by two blocks and now belongs to
  // b.core-sync; this points at a file only b.ui-control owns.
  {
    const r = runNode('scripts/observe_file_edit.mjs', ['frontend/atlas_design/panels.jsx']);
    ...
    eq('observe.known: cursor_edit line appended to b.ui-control', /cursor_edit\tpass\t.*atlas_design\/panels\.jsx/.test(log));
