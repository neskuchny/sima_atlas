...
window.SIMA_BOOTSTRAP = {
  ...
  "acceptanceSummary": {
    "generated_at": "2026-05-04T23:44:42.282Z",
    "blocks": [
      {
  ...
  "acceptanceRuns": {
    "b.acceptance-verifier-loop": {
      ...
      "checked_at": "2026-05-04T23:44:46.907Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "evidence": "node tests/parse_acceptance.selftest.mjs → exit 0 (45ms); first line: \"parse_acceptance.selftest: OK (9 test groups, all assertions green)\"",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/evidence_collectors.selftest.mjs → exit 0 (148ms); first line: \"evidence_collectors.selftest: OK (11 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A3",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/llm_judge.smoke.mjs → exit 0 (60ms); first line: \"llm_judge.smoke: OK (4 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/acceptance_verifier.e2e.smoke.mjs → exit 0 (319ms); first line: \"acceptance_verifier.e2e.smoke: OK (5 phases — verifier writes report; gate rejects fail; gate accepts pass; regression detected; proposal created)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A5",
    ...
    "b.agent-orchestrator": {
      ...
      "checked_at": "2026-05-04T23:44:44.824Z",
      "assertions": [
        {
          "id": "A1",
          "label": "hooks logic",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/cursor_hooks_actions.test.mjs → exit 0 (491ms); first line: \"cursor_hooks_actions.test: OK (9 cases)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A3",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/cursor_hooks_actions.test.mjs → exit 0 (472ms); first line: \"cursor_hooks_actions.test: OK (9 cases)\"",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/cursor_hooks_actions.test.mjs → exit 0 (461ms); first line: \"cursor_hooks_actions.test: OK (9 cases)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A5",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/cursor_live.headless.smoke.mjs → exit 0 (744ms); first line: \"cursor_live.headless.smoke: OK (5 phases — hooks valid, drift guard fires, file-edit logged, context pack emitted, detailed suite green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A6",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/validate_agent_parity.mjs → exit 0 (42ms); first line: \"Agent parity validation: OK\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        }
      ]
    },
    "b.core-sync": {
      ...
      "checked_at": "2026-05-04T23:44:42.476Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.db": {
      ...
      "checked_at": "2026-05-04T23:44:42.570Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/db_schema.json → 1 files (min=1); newest 3790min ago",
          "reasoning": "1 files match (≥1)"
        },
        {
          "id": "A4",
    ...
    "b.docs": {
      ...
      "checked_at": "2026-05-04T23:44:44.879Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/validate_no_template_placeholders.mjs → exit 0 (51ms); first line: \"Template-placeholder validation: OK (10 blocks scanned)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
    ...
    "b.llm-gateway": {
      ...
      "checked_at": "2026-05-04T23:44:45.382Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/llm_gateway.selftest.mjs → exit 0 (67ms); first line: \"llm_gateway.selftest: OK (4 cases)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node scripts/simulate_conversation_branches.mjs → exit 0 (299ms); first line: \"PASS: created b.realtime-ingestion in graph.json\"",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/llm_traces/*.json → 5703 files (min=1); newest 0min ago",
          "reasoning": "5703 files match (≥1)"
        },
        {
          "id": "A5",
          "label": null,
    ...
    "b.operator-profile-learner": {
      ...
      "checked_at": "2026-05-04T23:44:46.029Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/pick_template.selftest.mjs → exit 0 (60ms); first line: \"pick_template.selftest: OK (8 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A3",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/dont_use_management.selftest.mjs → exit 0 (237ms); first line: \"dont_use_management.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/operator_profile_lessons.smoke.mjs → exit 0 (60ms); first line: \"operator_profile_lessons.smoke: OK (6 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A5",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/operator_profile_inject.smoke.mjs → exit 0 (222ms); first line: \"operator_profile_inject.smoke: OK (4 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A6",
    ...
    "b.smoke-sandbox": {
      ...
      "checked_at": "2026-05-04T23:44:51.029Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/mcp_smoke_e2e.mjs → exit 0 (326ms); first line: \"mcp_smoke_e2e: OK\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        }
      ]
    },
    "b.ui-control": {
      ...
      "checked_at": "2026-05-04T23:44:42.332Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.user-docs-generator": {
      ...
      "checked_at": "2026-05-04T23:44:50.703Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/introspect_block_ui.selftest.mjs → exit 0 (51ms); first line: \"introspect_block_ui.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/screenshots_integration.selftest.mjs → exit 0 (3440ms); first line: \"screenshots_integration.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/user_docs_drift.selftest.mjs → exit 0 (190ms); first line: \"user_docs_drift.selftest: OK (5 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A5",
  ...
  "operatorProfile": {
    "operator_id": "default",
    "updated_at": "2026-05-04T23:54:59.886Z",
    "_status": "warming_up",
    "_min_data": {
      "done_transitions": 2,
      "done_required": 5,
