...
window.SIMA_BOOTSTRAP = {
  ...
  "acceptanceSummary": {
    "generated_at": "2026-05-03T17:46:00.989Z",
    "blocks": [
      {
  ...
  "acceptanceRuns": {
    "b.acceptance-verifier-loop": {
      ...
      "checked_at": "2026-05-03T17:46:03.000Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.agent-orchestrator": {
      ...
      "checked_at": "2026-05-03T17:46:02.540Z",
      "assertions": [
        {
          "id": "A1",
          "label": "hooks logic",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/validate_agent_parity.mjs → exit 0 (39ms); first line: \"Agent parity validation: OK\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        }
      ]
    },
    "b.core-sync": {
      ...
      "checked_at": "2026-05-03T17:46:00.997Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.db": {
      ...
      "checked_at": "2026-05-03T17:46:00.999Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.docs": {
      ...
      "checked_at": "2026-05-03T17:46:02.586Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.llm-gateway": {
      ...
      "checked_at": "2026-05-03T17:46:02.994Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/llm_gateway.selftest.mjs → exit 0 (55ms); first line: \"llm_gateway.selftest: OK (4 cases)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node scripts/simulate_conversation_branches.mjs → exit 0 (264ms); first line: \"PASS: created b.realtime-ingestion in graph.json\"",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/llm_traces/*.json → 1764 files (min=1); newest 0min ago",
          "reasoning": "1764 files match (≥1)"
        },
        {
          "id": "A5",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/llm_extraction.eval.mjs → exit 0 (62ms); first line: \"llm_extraction.eval — overall avg=1.000 (cases=30/30)\"",
    ...
    "b.operator-profile-learner": {
      ...
      "checked_at": "2026-05-03T17:46:02.998Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.smoke-sandbox": {
      ...
      "checked_at": "2026-05-03T17:46:03.003Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.ui-control": {
      ...
      "checked_at": "2026-05-03T17:46:00.993Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.user-docs-generator": {
      ...
      "checked_at": "2026-05-03T17:46:03.002Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
  ...
  "operatorProfile": {
    "operator_id": "default",
    "updated_at": "2026-05-03T17:46:00.058Z",
    "_status": "warming_up",
    "_min_data": {
      "done_transitions": 2,
      "done_required": 5,
