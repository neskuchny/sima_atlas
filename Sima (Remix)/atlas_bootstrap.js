...
window.SIMA_BOOTSTRAP = {
  ...
  "acceptanceSummary": {
    "generated_at": "2026-05-04T16:57:50.082Z",
    "blocks": [
      {
  ...
  "acceptanceRuns": {
    "b.acceptance-verifier-loop": {
      ...
      "checked_at": "2026-05-04T16:57:55.032Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.agent-orchestrator": {
      ...
      "checked_at": "2026-05-04T16:57:52.787Z",
      "assertions": [
        {
          "id": "A1",
          "label": "hooks logic",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/cursor_hooks_actions.test.mjs → exit 0 (507ms); first line: \"cursor_hooks_actions.test: OK (9 cases)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A5",
    ...
    "b.core-sync": {
      ...
      "checked_at": "2026-05-04T16:57:50.294Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.db": {
      ...
      "checked_at": "2026-05-04T16:57:50.398Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/db_schema.json → 1 files (min=1); newest 3384min ago",
          "reasoning": "1 files match (≥1)"
        },
        {
          "id": "A4",
    ...
    "b.docs": {
      ...
      "checked_at": "2026-05-04T16:57:52.841Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.llm-gateway": {
      ...
      "checked_at": "2026-05-04T16:57:53.363Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/llm_traces/*.json → 4050 files (min=1); newest 0min ago",
          "reasoning": "4050 files match (≥1)"
        },
        {
          "id": "A5",
          "label": null,
    ...
    "b.operator-profile-learner": {
      ...
      "checked_at": "2026-05-04T16:57:54.083Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/dont_use_management.selftest.mjs → exit 0 (265ms); first line: \"dont_use_management.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
    ...
    "b.smoke-sandbox": {
      ...
      "checked_at": "2026-05-04T16:57:59.339Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.ui-control": {
      ...
      "checked_at": "2026-05-04T16:57:50.140Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.user-docs-generator": {
      ...
      "checked_at": "2026-05-04T16:57:58.972Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/screenshots_integration.selftest.mjs → exit 0 (3571ms); first line: \"screenshots_integration.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
  ...
  "operatorProfile": {
    "operator_id": "default",
    "updated_at": "2026-05-04T16:58:07.356Z",
    "_status": "warming_up",
    "_min_data": {
      "done_transitions": 2,
      "done_required": 5,
