...
window.SIMA_BOOTSTRAP = {
  ...
  "acceptanceSummary": {
    "generated_at": "2026-05-04T23:20:10.008Z",
    "blocks": [
      {
  ...
  "acceptanceRuns": {
    "b.acceptance-verifier-loop": {
      ...
      "checked_at": "2026-05-04T23:20:16.131Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "evidence": "node tests/parse_acceptance.selftest.mjs → exit 0 (59ms); first line: \"parse_acceptance.selftest: OK (9 test groups, all assertions green)\"",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/evidence_collectors.selftest.mjs → exit 0 (183ms); first line: \"evidence_collectors.selftest: OK (11 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A3",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/acceptance_verifier.e2e.smoke.mjs → exit 0 (434ms); first line: \"acceptance_verifier.e2e.smoke: OK (5 phases — verifier writes report; gate rejects fail; gate accepts pass; regression detected; proposal created)\"",
    ...
    "b.agent-orchestrator": {
      ...
      "checked_at": "2026-05-04T23:20:13.373Z",
      "assertions": [
        {
          "id": "A1",
          "label": "hooks logic",
          ...
          "evidence": "node scripts/validate_cursor_hooks.mjs → exit 0 (62ms); first line: \"cursor hooks validation: OK (4 events, 4 commands)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/cursor_live.headless.smoke.mjs → exit 0 (981ms); first line: \"cursor_live.headless.smoke: OK (5 phases — hooks valid, drift guard fires, file-edit logged, context pack emitted, detailed suite green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A6",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/validate_agent_parity.mjs → exit 0 (77ms); first line: \"Agent parity validation: OK\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        }
      ]
    },
    "b.core-sync": {
      ...
      "checked_at": "2026-05-04T23:20:10.269Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.db": {
      ...
      "checked_at": "2026-05-04T23:20:10.397Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/db_schema.json → 1 files (min=1); newest 3766min ago",
          "reasoning": "1 files match (≥1)"
        },
        {
          "id": "A4",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/validate_files_registry.mjs → exit 0 (64ms); first line: \"Files registry validation: OK (alive=197, archived=4, dead=0)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        }
      ]
    },
    "b.docs": {
      ...
      "checked_at": "2026-05-04T23:20:13.442Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.llm-gateway": {
      ...
      "checked_at": "2026-05-04T23:20:14.109Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/llm_gateway.selftest.mjs → exit 0 (78ms); first line: \"llm_gateway.selftest: OK (4 cases)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node scripts/simulate_conversation_branches.mjs → exit 0 (385ms); first line: \"PASS: created b.realtime-ingestion in graph.json\"",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "fs_glob",
          "evidence": "glob atlas/llm_traces/*.json → 5335 files (min=1); newest 0min ago",
          "reasoning": "5335 files match (≥1)"
        },
        {
          "id": "A5",
          "label": null,
    ...
    "b.operator-profile-learner": {
      ...
      "checked_at": "2026-05-04T23:20:14.961Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/operator_profile.selftest.mjs → exit 0 (84ms); first line: \"operator_profile.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A2",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/pick_template.selftest.mjs → exit 0 (61ms); first line: \"pick_template.selftest: OK (8 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A3",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/dont_use_management.selftest.mjs → exit 0 (302ms); first line: \"dont_use_management.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/operator_profile_inject.smoke.mjs → exit 0 (314ms); first line: \"operator_profile_inject.smoke: OK (4 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A6",
    ...
    "b.smoke-sandbox": {
      ...
      "checked_at": "2026-05-04T23:20:20.889Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "exit_code",
          "evidence": "node scripts/mcp_smoke_e2e.mjs → exit 0 (442ms); first line: \"mcp_smoke_e2e: OK\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        }
      ]
    },
    "b.ui-control": {
      ...
      "checked_at": "2026-05-04T23:20:10.079Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
    ...
    "b.user-docs-generator": {
      ...
      "checked_at": "2026-05-04T23:20:20.445Z",
      "assertions": [
        {
          "id": "A1",
          "label": null,
        ...
        },
        {
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/user_docs.smoke.mjs → exit 0 (135ms); first line: \"user_docs.smoke: OK (5 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A3",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/screenshots_integration.selftest.mjs → exit 0 (3883ms); first line: \"screenshots_integration.selftest: OK (7 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A4",
          ...
          "verdict": "pass",
          "evidence_kind": "selftest_run",
          "evidence": "node tests/user_docs_drift.selftest.mjs → exit 0 (224ms); first line: \"user_docs_drift.selftest: OK (5 test groups, all assertions green)\"",
          "reasoning": "shell exit code 0 and stdout matches /OK/"
        },
        {
          "id": "A5",
  ...
  "operatorProfile": {
    "operator_id": "default",
    "updated_at": "2026-05-04T23:24:21.618Z",
    "_status": "warming_up",
    "_min_data": {
      "done_transitions": 2,
      "done_required": 5,
